...
#define OS_BRCS MT(KC_LGUI, KC_LBRC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    CTL_PRNS , KC_Z     , KC_X     , KC_C     , KC_V     , JP_SCLN   ,                                       KC_G     , KC_D     , KC_M     , KC_J     , KC_B     , KC_SLASH ,
               OS_BRCS  , MOD_LALT ,                   LY2_ENT, KC_BTN1, KC_INT5,              LY3_INT4  , SFT_SPC     , KC_0     , KC_PSCR  , TG(1)
  ...
  [2] = LAYOUT_universal(
    ...
    SSNP_VRT ,  SSNP_HOR, KC_LEFT  , KC_UP   , KC_DOWN  , KC_RGHT  ,                                         C(KC_Z)  , C(KC_X)  , C(KC_C)  , C(KC_V)  , KC_PGUP  , _______  ,
                  SSNP_FRE , _______ , _______  ,         _______  , _______  ,                 A(KC_LEFT),  A(KC_RGHT)  , _______       , _______  , KC_PGDN
  ),
